    ...
    <section className="relative overflow-hidden bg-background">
        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Launch your concepts quickly and gather meaningful insights from actual users. Perfect
              for validating products, features, and user experiences before full development.
            </p>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  ...
                  alt="Testing dashboard interface showing user feedback analytics"
                  fill
            ...
            <div className="absolute -right-6 -top-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold">247</span> running
              </p>
            </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm">
          <div className="relative max-w-4xl mx-4 bg-card rounded-lg border shadow-2xl">
            <button
              onClick={() => setIsModalOpen(false)}
              className="absolute -top-4 -right-4 bg-background border rounded-full p-2 shadow-lg hover:bg-muted"
            >
              ✕
            </button>
